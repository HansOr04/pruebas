...
export default function SpacesContent() {
  ...
  const [filteredConsultories, setFilteredConsultories] = useState(consultories);
  ...
  useEffect(() => {
    if (searchTerm) {
      ...
      const filtered = consultories.filter(
        consultory => 
      ...
      setFilteredConsultories(consultories);
    }
  }, [searchTerm]);
    ...
    return (
      <>
        <div className="pt-4 px-4">
          ...
          {/* Search box */}
          <form onSubmit={handleSearchSubmit} className="relative flex w-full mb-6">
            <input
              type="text"
        ...
        <div className="px-4 pb-20">
          <h2 className="text-xl font-bold mb-4">
            {searchTerm ? `Resultados para "${searchTerm}"` : "Todos los espacios"}
          </h2>
