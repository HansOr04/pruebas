...
const MobileSpaceDetails: React.FC<MobileSpaceDetailsProps> = ({ space }) => {
    ...
    <div className="pb-20">
      ...
      <div className="p-4">
        ...
        <p className="text-gray-700 text-sm mb-6">
          Espacio profesional ideal para terapeutas y profesionales de la salud
          mental. Ambiente tranquilo y acogedor que promueve la relajación y el
          bienestar.
        </p>
        ...
        <div className="mb-6">
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            <p className="text-sm text-gray-700 mb-1">
              <span className="font-medium">Días:</span> Lunes, Martes,
              Miércoles, Jueves, Viernes
            </p>
            <p className="text-sm text-gray-700">
              <span className="font-medium">Horario:</span> 9:00 - 18:00
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="px-6 py-3 bg-[var(--primary-text-color)] text-white font-bold rounded-full hover:bg-[var(--primary-hover)] transition-colors">
            Reservar
          </button>
        </div>
