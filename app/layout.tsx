...
// Nota: Esta es una solución alternativa ya que metadata no puede usarse en un componente cliente
// En una implementación real, podrías mover esto a un layout separado
